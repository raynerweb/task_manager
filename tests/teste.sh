...
# STATUS_GET_TASKS="@GET /tasks"

# if [[ $TASKS != *"["* ]] || [[ $TASKS != *"]"* ]]
# then
# 	STATUS_GET_TASKS="${STATUS_GET_TASKS} ERROR"
# 	echo $STATUS_GET_TASKS
# 	exit 1
# fi
# STATUS_GET_TASKS="${STATUS_GET_TASKS} OK"
# echo $STATUS_GET_TASKS
# echo $TASKS
# echo ""
...
# STATUS_GET_ID="@GET /tasks/${SAVED}"
# SAVED_ID=$(curl -s http://$IP:$PORT/tasks/$SAVED -X GET -H "Content-Type: application/json" -H "x-access-token: $TOKEN")
# echo $SAVED_ID
